...
export const slimCard: Parameters<typeof CourseCard>[0][] = [
  {
    backgroundUrl: '/media/posters/1.jpg',
    title: 'Tracing Your Roots Through Food',
    // subtitle: 'Chai Li',
    badges: [{ display: 'Live' }, { display: 'Food' }],
    isFavorited: true,
    // price: '49.65',
    // quota: '8/10',
    date: 'Jan 21-29, 22',
  ...
  {
    backgroundUrl: '/media/posters/2.jpg',
    title: 'Mathematical Thinking',
    // subtitle: 'Kevin Sanjaya',
    badges: [{ display: 'Offline' }, { display: 'Science & Tech' }],
    isFavorited: true,
    // price: '49.65',
    // quota: '8/10',
    date: 'Jan 21-29, 22',
  ...
  {
    backgroundUrl: '/media/posters/3.jpg',
    title: 'Purposeful Communication',
    isFavorited: false,
    // subtitle: 'Richard Dawkins',
    badges: [{ display: 'Recording' }, { display: 'Business' }],
    // price: '49.65',
    date: 'Jan 21-29, 22',
    href: '/class/detail',
  },
  {
    backgroundUrl: '/media/posters/3.png',
    title: 'Tracing Your Roots Through Food',
    // subtitle: 'Chai Li',
    badges: [{ display: 'Live' }, { display: 'Food' }],
    isFavorited: true,
  ...
  {
    backgroundUrl: '/media/posters/4.png',
    title: 'Mathematical Thinking',
    // subtitle: 'Kevin Sanjaya',
    badges: [{ display: 'Offline' }, { display: 'Science & Tech' }],
    isFavorited: true,
  ...
  {
    backgroundUrl: '/media/posters/5.png',
    title: 'Purposeful Communication',
    isFavorited: false,
    // subtitle: 'Richard Dawkins',
    badges: [{ display: 'Recording' }, { display: 'Business' }],
  ...
  {
    backgroundUrl: '/media/posters/6.png',
    title: 'Creative Collaboration and Fashion',
    // subtitle: 'Richard Dawkins',
    badges: [{ display: 'Recording' }, { display: 'Design & Style' }],
    isFavorited: true,
    // price: '49.65',
    // quota: '8/10',
    date: 'Jan 21-29, 22',
  ...
  {
    backgroundUrl: '/media/posters/7.png',
    title: 'Inclusive Leadership',
    badges: [{ display: 'Recording' }, { display: 'Community & Government' }],
    isFavorited: false,
    // price: '49.65',
    // quota: '8/10',
    date: 'Jan 21-29, 22',
  ...
  // {
  //   backgroundUrl: '/media/posters/card-bg (11).jpg',
  ...
  // },
  // {
  //   backgroundUrl: '/media/posters/card-bg (12).jpg',
  ...
  // },
  // {
  //   backgroundUrl: '/media/posters/card-bg (13).jpg',
...
export const largeCard: Parameters<typeof CourseCard>[0][] = [
  {
    backgroundUrl: '/media/posters/1.jpg',
    title: 'Tracing Your Roots Through Food',
    // subtitle: 'Chai Li',
...
`
export const blogCards: ReactProps<typeof BlogCard>[] = [
  {
    backgroundUrl: '/media/blog-thumb.jpg',
